...
| Project | Description | Skills Learned | Demo |
|---------|-------------|----------------|------|
| **CS50 Finance** | A Flask-based stock portfolio web app that allows users to register, log in, look up real-time stock prices, buy and sell shares, view their portfolio and transaction history, and change passwords. Implements secure user authentication, database integration with SQLite, and dynamic data rendering. | Python, Flask, SQLite, CS50 SQL Library, Jinja2 Templates, Bootstrap, Secure Password Hashing, RESTful Routes, API Integration | [![Watch the demo](https://img.youtube.com/vi/S75_0rQDCQA/0.jpg)](https://www.youtube.com/watch?v=S75_0rQDCQA) |
| **Birthdays** | A Flask web application that allows users to submit and store birthday entries (name, month, day) into an SQLite database, and view all stored entries dynamically. Demonstrates form handling, database integration with CS50 SQL library, and template rendering with Jinja2. | Python, Flask, SQLite, CS50 Library, HTML, Jinja2 Templates, HTTP Methods (GET, POST) | [![Watch the demo](https://img.youtube.com/vi/6h-hDDQgK0I/0.jpg)](https://www.youtube.com/watch?v=6h-hDDQgK0I) |
...
| Project | Description | Skills Learned | Demo |
|---------|-------------|----------------|------|
| **ReportFix** | A Flask web app for community infrastructure issue reporting with user authentication, photo uploads, and map-based visualization. Admins can manage and resolve reports. | Python, Flask, SQLite, JavaScript, Leaflet.js | [Check out the full ReportFix documentation](ReportFix.md) |
